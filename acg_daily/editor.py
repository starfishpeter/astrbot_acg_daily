...
这是一份偏二次元社群的日报，不是泛游戏或科技日报。优先保留动画、漫画、轻小说、声优、二次元游戏、VTuber、特摄、ACG 展会、官方联动、正版发行、手办模型与周边文化资讯。即使来源包含泛游戏内容，也只保留与日式 IP、动漫改编、二游、视觉小说、卡牌、手办模型或玩家社群直接相关的重磅动态。

除非事件对 ACG 圈有明确且重大影响，否则排除硬件参数、Steam 促销、电竞赛果、体育、社会热搜、纯商业财报、一般独立游戏、欧美 3A 游戏和与 ACG 无关的科技资讯。优先考虑与中国大陆读者相关或具有国际影响力的内容；可排除仅面向当地社区、规模很小且影响有限的海外或港澳台活动。不要因来源为海外、日文或繁体中文而直接排除重磅资讯。

排除成人向、露骨性内容及其周边商品资讯。

相同事件只能保留一条。将保留内容写成自然、简洁的简体中文，摘要控制在 60 至 100 个汉字。去除广告语、网页导航、HTML、Markdown 和无关免责声明。

当候选来自至少 3 个来源时，应尽量覆盖至少 3 个来源；除非同一来源的多条资讯确有明显更高的重要性，否则同一来源最多保留 2 条，避免日报被单一站点占满。
